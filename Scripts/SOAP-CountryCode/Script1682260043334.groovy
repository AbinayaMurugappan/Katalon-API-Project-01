...
response1 = WS.sendRequestAndVerify(findTestObject('SOAP WebService/CountryInfo'))
...
WS.sendRequest(findTestObject('Object Repository/SOAP WebService/CapitalCity'))
